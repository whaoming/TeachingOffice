...
//	private Context context;
	...
	public OfficeElectiveCourseAdapter(Context ct, LayoutInflater inflater,
			List<ElectiveCourseColumn> list) {
//		this.context = ct;
		this.list = list;
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		ElectiveCourseColumn column = list.get(groupPosition);
		if(convertView == null){
		...
		if (isExpanded) {
			holder.iv.setBackgroundResource(R.drawable.group_up);
		} else {
			holder.iv.setBackgroundResource(R.drawable.group_down);
		}
		return convertView;
	}
