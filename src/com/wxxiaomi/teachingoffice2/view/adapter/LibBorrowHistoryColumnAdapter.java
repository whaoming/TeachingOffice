...
public class LibBorrowHistoryColumnAdapter extends BaseAdapter {

	private Context context;
	private List<BookBorrowedState> list;

	public LibBorrowHistoryColumnAdapter(Context ct,List<BookBorrowedState> list) {
		this.context = ct;
		this.list = list;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context,
					R.layout.item_lib_borrow_history, null);
		...
		holder.tv_name.setText((position+1)+","+column.getName());
