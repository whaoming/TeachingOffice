package com.wxxiaomi.teachingoffice2.bean;
...
//	private String btn_zcj;
	...
	private Map<String,String> getHistoryScorePars = new HashMap<String, String>();
	
	
	public Map<String, String> getGetHistoryScorePars() {
		return getHistoryScorePars;
	}

	public void setGetHistoryScorePars(Map<String, String> getHistoryScorePars) {
